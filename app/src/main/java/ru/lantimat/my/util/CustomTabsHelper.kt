...
import ru.cometrica.arbook.util.KeepAliveService
...
object CustomTabsHelper {
    ...
    fun addKeepAliveExtra(context: Context, intent: Intent) {
        val keepAliveIntent: Intent = Intent().setClassName(
            context.packageName,
    ...
    private fun hasSpecializedHandlerIntents(
        ...
        try {
            ...
            Timber.e(e, "Can't get specialized handlers for intent: $intent")
        }
        return false
    }
}